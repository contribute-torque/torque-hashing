{
    "targets": [
		...
		"defyx/src/blake2/sha256.c",
		"defyx/src/blake2/yescrypt-best.c",
                "defyx/src/aes_hash.cpp",
                "defyx/src/argon2_ref.c",
                "defyx/src/dataset.cpp",
                "defyx/src/soft_aes.cpp",
                "defyx/src/virtual_memory.cpp",
                "defyx/src/vm_interpreted.cpp",
                "defyx/src/allocator.cpp",
                "defyx/src/assembly_generator_x86.cpp",
                "defyx/src/instruction.cpp",
                "defyx/src/defyx.cpp",
                "defyx/src/superscalar.cpp",
                "defyx/src/vm_compiled.cpp",
                "defyx/src/vm_interpreted_light.cpp",
                "defyx/src/argon2_core.c",
                "defyx/src/blake2_generator.cpp",
                "defyx/src/instructions_portable.cpp",
                "defyx/src/reciprocal.c",
                "defyx/src/virtual_machine.cpp",
                "defyx/src/vm_compiled_light.cpp",
                "defyx/src/blake2/KangarooTwelve.c",
                "defyx/src/blake2/KeccakP-1600-reference.c",
                "defyx/src/blake2/KeccakSpongeWidth1600.c",
                "defyx/src/blake2/blake2b.c",

                '<!@(uname -a | grep "x86_64" >/dev/null && echo "defyx/src/jit_compiler_x86_static.S" || echo)',
                '<!@(uname -a | grep "x86_64" >/dev/null && echo "defyx/src/jit_compiler_x86.cpp" || echo)',
            ],
            "include_dirs": [
                "xmrig",
                "xmrig/3rdparty",
