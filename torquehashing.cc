...
NAN_METHOD(yespower) {
    ...
    if (variant != 9) {
        return THROW_ERROR_EXCEPTION("Invalid hashing variant");
    }
   ...
   v8::Local<v8::Value> returnValue = Nan::NewBuffer(output, 32).ToLocalChecked();
   info.GetReturnValue().Set(returnValue);
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
NODE_MODULE(torquehashing, init)
